...
class LanguageConditionEditorDialogState
  ...
  void _save() {
    if (_paramController.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Tr((_) => Text('Parameter name cannot be empty'.tr)),
          backgroundColor: Colors.red,
        ),
      );
      return;
    ...
    if (_conditionKeys.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Tr((_) => Text('At least one condition is required'.tr)),
          backgroundColor: Colors.red,
        ),
      );
      return;
      ...
      if (controller == null || controller.text.trim().isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Tr(
              (_) =>
                  Text('Condition "@{key}" cannot be empty'.trP({'key': key})),
            ),
            backgroundColor: Colors.red,
          ),
        );
                        ...
                        children: [
                          ...
                          if (_conditionKeys.isEmpty)
                            ...
                            ..._conditionKeys.map((conditionKey) {
                              final controller =
                                  _conditionControllers[conditionKey]!;
                              final isDefault =
                                  conditionKey == '_' ||
